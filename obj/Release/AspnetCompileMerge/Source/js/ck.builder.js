...
var Builder = {
    ...
    getPricingFromAPI: function (pid) {
        ...
        //13-5-2019 
        // remove SetUp fee for all Sublimation Printing  product
        //if (Product.printingOptions == "Sublimation Printing") {
                    ...
                    if (IsAdmin == false) {
                        ...
                        if (Builder.userData != null) {
                            if (data.UserId != Builder.userData.ID) {
                                ...
                                //start
                                if (data.Status == "NEW" && Builder.userData.ID > 0) {
    ...
    initUi: function () {
        ...
        $(".modal.dealer .submit").bind('click', function (e) {
            ...
            // save OriginalOrderNo before send to dealer 
            ...
            if ($("#cliffkeen_checkbox").prop('checked') == true) {
                ...
                Api.call(Api.endpoints.AssignDesignToDealerSubmit, JSON.stringify({ "id": Builder.id, "DealerEmail": cliffkeen_email, "message": message, "CurrentPageUrl": CurrentPageUrl, "originalOrderNo": originalOrderNo }), function () {
                    Api.call(Api.endpoints.saveDesign,
                ...
                Api.call(Api.endpoints.AssignDesignToDealerSubmit, JSON.stringify({ "id": Builder.id, "DealerID": Builder.chosenDealer.id, "DealerEmail": Builder.chosenDealer.email, "message": $(".modal.dealer textarea#EmailNotes").val(), "CurrentPageUrl": CurrentPageUrl, "originalOrderNo": originalOrderNo }), function (response) {
                    Api.call(Api.endpoints.saveDesign,
                    JSON.stringify(Builder.productDataForSaving("with-dealer", false)),
                    function () {
                        var code = 301;
    ...
    KitcompileReview: function (kitNo) {
        ...
        if (CustKit['kit_' + kitNo].hasOwnProperty('printingOption')) {
            ...
            //Important-Comment this code for Displaying printing type under "Review Order" under "DESIGN" section
            //    else {
            ...
            if (data.ID != '0' && data.ID[0] != '-') {
                ...
                //start
                {
                    ...
                    Api.call(Api.endpoints.getDesign, JSON.stringify({
                        ...
                        if (Number(Builder.userData.ID) > 0 && Builder.userData.ID != null) {
                            $(".button.to-cart").addClass("processing");
